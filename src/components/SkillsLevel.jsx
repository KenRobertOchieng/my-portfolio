    ...
    <div className='space-y-2'>
        ...
        <div className='w-full h-3 bg-gray-300 dark:bg-gray-600 rounded-full'>
            <div className='animate-pulse'>
                <div className={`h-3 dark:bg-gradient-to-r dark:from-purple-950 dark:via-blue-700 dark:to-sky-300 rounded-full bg-gradient-to-r from-slate-700 to-slate-800`} style={{width:percentage}}></div>
            </div>
        </div>
    </div>
  )
